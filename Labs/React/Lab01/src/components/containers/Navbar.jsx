            ...
            <div className="navbar main">
                    ...
                    <ul className="topnav pull-right">
                        ...
                        <li className="account">
                            <a data-toggle="dropdown" className="glyphicons logout lock">
                                <span className="hidden-phone text">mosaicpro</span><i></i>
                            </a>

                            <ul className="dropdown-menu pull-right">
                                <li><a className="glyphicons cogwheel">Settings<i></i></a></li>
                                <li>
                                    <span>
                                        <a className="btn btn-default btn-small pull-right" style={{ padding: "2px 10px", background: "#fff" }} >Sign Out</a>
                                    </span>
                                </li>
                            </ul>
                        </li>
